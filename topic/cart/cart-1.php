<?php
    ...
    $sql = "SELECT * FROM duel WHERE buyer_id = '$id'"; //修改成你要的 SQL 語法
    $result = mysqli_query($conn,$sql) or die("Error");
...
<div class="flex">
    ...
    <input type="button" class="flex-child" name="alfabet"  value="待出貨">
        ...
        <?php
            if($yee=="0"){
                ...
                while($row = mysqli_fetch_array($result)){
                    $count=$row[5];
                    $state=$row[11];
                    $sql3 = "SELECT commodity_id,commodity_name,commodity_price,commodity_introduce_picture FROM commodity WHERE commodity_id = '$row[4]'";
                    $result1 = mysqli_query($conn,$sql3) or die("Error");
        ...
        ?>
            <div class="item_container" >
                <div class="item_header item_body">
                    ...
                    <div id = "<?php echo $com_id;?>" class="amount"><?php echo $com_price*$count;?></div>
                    <div class="operate">
                        <?php 
                        if($state==='1'){
                            $state1= '未成立';

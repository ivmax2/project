<?php 
    ...
    $sql = "SELECT * FROM duel WHERE seller_id = '$id' AND duel_state = '1'"; //修改成你要的 SQL 語法
    $result = mysqli_query($conn,$sql) or die("Error");
...
<body style="background-color: #ffffff;">
    ...
    <article>
        <div id="first_page" style="background-color: #ffffff;">未成立訂單</div>
    </article>
    <div style="color: rgba(133,135,150,0);margin: 40px;"></div>
    <form action="ln.php" method="post" id="clear-form">
        <tr>
            <td>
        ...
        <input type="submit" value="接單" name="zero"/>
        <input type="submit" value="棄單" name="zero"/>
        <div>
            <div class="container">
                <?php
                    if($yee=="0"){
                ...
                <?php
                        ...
                        while($row = mysqli_fetch_array($result)){
                            ...
                            $phone=$row[7];
                            $address=$row[6];
                            $sql = "SELECT * FROM commodity WHERE commodity_id = '$row[4]'";
                ...
                <div>
                    <div class="header body">
                        <input type="checkbox" name="chkPerson[]" value="<?php echo $duel_id?>"/>
                        <div class="tt">
                            <div class="detail">
